...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
              <title>Perfume Store - Profile</title>
    ...
    <body style="margin-top: 150px;">
        <div class="container light-style container-p-y" style=" align-content: center; justify-content: center;justify-items: center; margin-bottom: 50px;">
            <h2 class="font-weight-bold py-3 mt-2">
                Customer Profile
            </h2>
            <div class="card overflow-hidden" style="margin-bottom: 60px; width: 700px; margin-top: 20px; margin-left: 20px">

                <div class="row no-gutters row-bordered row-border-light">
                    <div class="col-md-3 pt-0" style="width: auto;" >
                        <div class="list-group list-group-flush account-settings-links" style="background: #e3d9d9; border-radius: 5px;">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <form class="tab-pane fade active show" id="account-general">
                                ...
                                <div class="text-left mt-3" style="display: flex;justify-content: center;">
                                    <button  id="SaveChangeBtn" class="btn btn-success" style="height: 50px;">Save changes</button>
