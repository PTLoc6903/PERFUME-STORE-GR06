    ...
    <body>
        <div class="container-i">
            <main style="background: white;">
                ...
                %>
                <!-- Add Perfume Table -->
                <h2 style="font-size:25px;display: flex;justify-content: center;">Enter Perfume Information</h2>
                <form action="addPerfumeManager" method="POST" style="justify-items: center;">
                    <div class="perfume-info" style="display: block;width: 40%;">
                        <div class="left-info">
                            <ul>
                                <li  style="border-radius: 20px; height: 20px;border: solid;"><label>Perfume ID: </label><input type="text" name="perfume_id" value="${perfume_id}" readonly style=""></li>
                                <li  style="border-radius: 20px;height: 20px;border: solid;"><label>Perfume Name: </label><input type="text" name="perfume_name" value style=""></li>
                                <li  style="border-radius: 20px; height: 20px;border: solid;"><label>Price: </label><input type="number" name="price" value style="width: "><label>$</label></li>
                                <li  style="border-radius: 20px; height: 20px;border: solid;"><label>Sale: </label><input type="number" name="sale" value style="width: "><label>%</label></li>
                                <li  style="border-radius: 20px;border: solid;">
                                    <label style="border: none;">Select file image: </label>
                                ...
                                <li style="width: 559px; margin-left: 0px; border-radius: 25px; border: solid;"><img style="width: 559px;height: 200px;" id="imagePreview" src>
                                </li>
                        ...
                        <div class="right-info" style="margin-left: 5%;">
                            <ul>
                                ...
                                <li style="border-radius: 25px; height: 50px; width: 559px; border: solid;"><label>Description: </label>
                                    <textarea style="resize: none; width: 370px;" cols="30" rows="2" name="description" ></textarea>
                                </li>
                                <li style="resize: none;border-radius: 25px; height: 50px; width: 559px; border: solid;" cols="30" rows="3" name="description"><label>Status: </label>
            ...
            <style>
                ...
                .perfume-info input[type=number] {
                    padding: 0px;
                    margin-left: 2px;
                    margin-right: 12px;
                    font-size: 20px;
                ...
                .right-info li:first-child select {
                    font-size: 16px;
                    width: 50%;
                    height: 40px;
                }
                .right-info li:nth-child(3) select {
                    font-size: 16px;
                    width: 50%;
                    height: 40px;
                }
